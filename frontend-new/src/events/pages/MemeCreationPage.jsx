...
export function MemeCreationPage() {
  const event = getEventBySlug('meme-creation');
  ...
  return (
    <div className="event-page">
      ...
      <div className="event-section" id="flow">
        <p className="eyebrow">Flow</p>
        <h2 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: 'clamp(2rem, 5vw, 3rem)', lineHeight: 1.1, margin: '0 0 24px', color: 'var(--ink)' }}>From Prompt to Judging</h2>
        <EventTimeline items={event.flow} title="Creative Process" />
      </div>
