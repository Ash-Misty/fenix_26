      ...
      <div className="pp-shell">
        <header className="pp-nav">
          ...
          <nav className={menuOpen ? 'pp-links open' : 'pp-links'}>
            <button type="button" onClick={goHome}>Home</button><button type="button" onClick={() => scrollTo('events')}>Events</button><button type="button" onClick={() => scrollTo('about')}>About</button><button type="button" onClick={() => scrollTo('gallery')}>Gallery</button><button type="button" onClick={() => scrollTo('contact')}>Contact</button>
          </nav>
