...
export function PaperPresentationPage() {
  const event = getEventBySlug('paper-presentation');
  ...
  return (
    <div className="event-page">
      ...
      <div className="event-section">
        <TopicGrid topics={event.topics} title="Research Topics" />
      </div>
      <div className="event-section">
        <EventTimeline items={event.timeline} title="Submission Timeline" />
      </div>
